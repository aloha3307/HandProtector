...
class WindowMgr:
    ...
    """ 設定寬高XY(window_width,window_height,window_x,window_y) """
    ### 設定目標視窗的寬度及高度及XY座標 ###
    def set_window_width_height_xy(self,window_width,window_height,window_x,window_y):
        self.set_window_state('')
        win32gui.MoveWindow(self._handle,window_x,window_y,window_width,window_height,True)
